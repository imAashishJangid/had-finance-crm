                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          {customer.customerImage?.url ? (
                            <img
                              src={customer.customerImage.url}
                              alt={customer.name}
                              className="h-12 w-12 rounded-xl object-cover border-2 border-border group-hover:border-primary/50 transition-colors"
                            />
                          ) : (
                            <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 flex items-center justify-center group-hover:border-primary/50 transition-colors">
                      ...
                      <TableCell>
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            <Badge
                              className={`text-xs px-2 py-1 ${idTypeStyles[customer.idType]}`}
                              variant="outline"
                            >
                              {customer.idType}
                            </Badge>
                      ...
                      <TableCell>
                        <Badge
                          className={`flex items-center gap-1.5 px-3 py-1.5 capitalize font-medium ${statusStyles[customer.status]}`}
                          variant="outline"
                        >
                          {getStatusIcon(customer.status)}
                          {customer.status}
