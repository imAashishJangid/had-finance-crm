          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/30 hover:bg-muted/30">
                ...
                <TableHead className="font-semibold">EMI No.</TableHead>
              ...
              {filteredPayments.map((payment) => {
                ...
                return (
                  <TableRow key={payment.id} className="hover:bg-muted/20">
                    ...
                    <TableCell className="font-medium text-accent">{payment.loanId}</TableCell>
                    <TableCell className="text-muted-foreground">{payment.emiNo}</TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Badge className={statusStyles[payment.status as keyof typeof statusStyles]}>
